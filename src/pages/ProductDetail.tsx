...
const ProductDetail = (props: Props) => {
    ...
    return (
        <div>
            ...
            <section className="text-gray-700 body-font overflow-hidden bg-slate-100 pt-[100px]">
                                ...
                                <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-200 mb-5">
                                    ...
                                    <div className="flex ml-6 items-center">
                                        ...
                                        <div className="">
                                            ...
                                            <input type="number" className="rounded border appearance-none border-gray-400 py-2 focus:outline-none focus:border-red-500 text-base pl-3 pr-10" min="1" value={`${count}` } {...register('quantity')} />
                                            <span onClick={() => setcount(count - 1)} className='bg-orange-500 p-2'><i className="fa-solid fa-minus text-lg text-white"></i></span>
                                        </div>
                                    </div>
                                </div>
