...
import { getall, read } from "../../api/category";
...
const CategoriesPage = (props: Props) => {
    ...
    const [CategoryPD, setCategoryPD] = useState<ProductType[]>([]);
            ...
            <article className="w-[1300px] mx-auto my-[50px] ">
                <div className="">
                    ...
                    <div className="mt-6 grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
                        {CategoryPD.map((product) => {
                            return <Link className="no-underline"  to={`/products/${product._id}`}>
                            <div className="group">
